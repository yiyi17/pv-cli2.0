'use strict';
const { isObject } = require('@msfe/usu-utils')
const path = require('path')
const formatPath = require('@msfe/usu-format-path')
const npmInstall = require('npminstall')
const { getDefaultRegistry, getNpmLatestVersion } = require('@msfe/usu-get-npm-info');
